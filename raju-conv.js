import { convertBackground, convertIcon, convertSpacing } from '../../helper/conversion';
...
const processConversionOutlineData = () => {
	...
	const processModuleData = () => {
		...
		const icon_bg_color = convertBackground( 'icon_bg_color', 'icon' );
		const text_container_bg_color = convertBackground( 'text_container_bg_color', 'label_container' );
		const header_container_bg_color = convertBackground( 'header_container_bg_color', 'header_container' );
