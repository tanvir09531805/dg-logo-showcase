...
//phpcs:disable -- Third party library
class DIFL_MobileDetect
{
    /**
     ...
     */
    public function getHttpHeader(string $header)
    {
     ...
     * @return string
     */
    private function prepareUserAgent(string $userAgent)
    {
     ...
     * @return boolean
     */
    protected function matchUAAgainstKey(string $key)
    {
     ...
     *
     */
    public function is(string $key, string $userAgent = null, array $httpHeaders = null)
    {
     ...
     */
    public function match($regex, string $userAgent = null)
    {
     ...
     *
     */
    public function prepareVersionNo(string $ver)
    {
