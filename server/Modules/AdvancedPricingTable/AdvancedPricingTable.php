...
class AdvancedPricingTable implements DependencyInterface {
  ...
  public static function custom_css() {
        return \WP_Block_Type_Registry::get_instance()->get_registered( 'difl/pricingtable' )->customCssFields;
    }
  ...
  public static function render_callback($attrs, $content, $block, $elements)
    {
        ...
        wp_enqueue_script('df-advanced-pricing-table');
        ...
        return Module::render(
            [
                ...
                'classnamesFunction' => [AdvancedPricingTable::class, 'module_classnames'],
                'moduleCategory' => $block->block_type->category,
                'stylesComponent' => [AdvancedPricingTable::class, 'module_styles'],
                'scriptDataComponent' => [AdvancedPricingTable::class, 'module_script_data'],
        ...
        add_action(
            ...
            function () use ($module_json_folder_path) {
                ModuleRegistration::register_module(
                    ...
                    [
                        'render_callback' => [ AdvancedPricingTable::class, 'render_callback' ],
          ]
        );
      }
        );
