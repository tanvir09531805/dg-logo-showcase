  ...
  public static function render_callback($attrs, $content, $block, $elements)
    {
        ...
        wp_enqueue_script('df-advanced-button');
        ...
        return Module::render(
            [
                ...
                'classnamesFunction' => [AdvancedButton::class, 'module_classnames'],
                'moduleCategory' => $block->block_type->category,
                'stylesComponent' => [AdvancedButton::class, 'module_styles'],
                'scriptDataComponent' => [AdvancedButton::class, 'module_script_data'],
        ...
        add_action(
            ...
            function () use ($module_json_folder_path) {
                ModuleRegistration::register_module(
                    ...
                    [
                        'render_callback' => [ AdvancedButton::class, 'render_callback' ],
          ]
        );
      }
        );
