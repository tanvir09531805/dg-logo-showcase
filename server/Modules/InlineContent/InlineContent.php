...
class InlineContent implements DependencyInterface {
  ...
  public static function custom_css() {
        return \WP_Block_Type_Registry::get_instance()->get_registered( 'difl/inline-contents' )->customCssFields;
    }
  ...
  public static function render_callback($attrs, $content, $block, $elements)
    {
        ...
        wp_enqueue_script('df-inline-content');
        ...
        return Module::render(
            [
                ...
                'classnamesFunction' => [InlineContent::class, 'module_classnames'],
                'moduleCategory' => $block->block_type->category,
                'stylesComponent' => [InlineContent::class, 'module_styles'],
                'scriptDataComponent' => [InlineContent::class, 'module_script_data'],
        ...
        add_action(
            ...
            function () use ($module_json_folder_path) {
                ModuleRegistration::register_module(
                    ...
                    [
                        'render_callback' => [ InlineContent::class, 'render_callback' ],
          ]
        );
      }
        );
