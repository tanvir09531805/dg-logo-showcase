...
class AdvancedGalleryItem implements DependencyInterface {
  ...
  public static function custom_css() {
        return \WP_Block_Type_Registry::get_instance()->get_registered( 'difl/imagegalleryitem' )->customCssFields;
    }
  ...
  public static function render_callback($attrs, $content, $block, $elements)
    {
        ...
        wp_enqueue_script('df-advanced-gallery-item');
        ...
        return Module::render(
            [
                ...
                'classnamesFunction' => [AdvancedGalleryItem::class, 'module_classnames'],
                'moduleCategory' => $block->block_type->category,
                'stylesComponent' => [AdvancedGalleryItem::class, 'module_styles'],
                'scriptDataComponent' => [AdvancedGalleryItem::class, 'module_script_data'],
        ...
        add_action(
            ...
            function () use ($module_json_folder_path) {
                ModuleRegistration::register_module(
                    ...
                    [
                        'render_callback' => [ AdvancedGalleryItem::class, 'render_callback' ],
          ]
        );
      }
        );
