...
class JustifiedGallery implements DependencyInterface {
  ...
  public static function custom_css() {
        return \WP_Block_Type_Registry::get_instance()->get_registered( 'difl/justifiedgallery' )->customCssFields;
    }
  ...
  public static function render_callback($attrs, $content, $block, $elements)
    {
        ...
        wp_enqueue_script('df-justified-gallery');
        ...
        return Module::render(
            [
                ...
                'classnamesFunction' => [JustifiedGallery::class, 'module_classnames'],
                'moduleCategory' => $block->block_type->category,
                'stylesComponent' => [JustifiedGallery::class, 'module_styles'],
                'scriptDataComponent' => [JustifiedGallery::class, 'module_script_data'],
        ...
        add_action(
            ...
            function () use ($module_json_folder_path) {
                ModuleRegistration::register_module(
                    ...
                    [
                        'render_callback' => [ JustifiedGallery::class, 'render_callback' ],
          ]
        );
      }
        );
