...
class PricingTableItem implements DependencyInterface {
  ...
  public static function custom_css() {
        return \WP_Block_Type_Registry::get_instance()->get_registered( 'difl/pricingtableitem' )->customCssFields;
    }
  ...
  public static function render_callback($attrs, $content, $block, $elements)
    {
        ...
        wp_enqueue_script('df-pricing-table-item');
  ...
  public function load()
    {
        $module_json_folder_path = DIFL_MODULES_JSON_PATH . '/pricing-table-item';
        ...
        add_action(
            ...
            function () use ($module_json_folder_path) {
                ModuleRegistration::register_module(
                    ...
                    [
                        'render_callback' => [ PricingTableItem::class, 'render_callback' ],
          ]
        );
      }
        );
