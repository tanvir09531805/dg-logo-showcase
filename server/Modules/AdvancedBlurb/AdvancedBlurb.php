...
class AdvancedBlurb implements DependencyInterface {
  ...
  public static function custom_css() {
        return \WP_Block_Type_Registry::get_instance()->get_registered( 'difl/advanced-blurb' )->customCssFields;
    }
  ...
  public static function render_callback($attrs, $content, $block, $elements)
    {
        ...
        wp_enqueue_script('df-advanced-blurb');
        ...
        return Module::render(
            [
                ...
                'classnamesFunction' => [AdvancedBlurb::class, 'module_classnames'],
                'moduleCategory' => $block->block_type->category,
                'stylesComponent' => [AdvancedBlurb::class, 'module_styles'],
                'scriptDataComponent' => [AdvancedBlurb::class, 'module_script_data'],
        ...
        add_action(
            ...
            function () use ($module_json_folder_path) {
                ModuleRegistration::register_module(
                    ...
                    [
                        'render_callback' => [ AdvancedBlurb::class, 'render_callback' ],
          ]
        );
      }
        );
