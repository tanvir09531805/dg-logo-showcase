...
class Stack implements DependencyInterface {
  ...
  public static function custom_css() {
        return \WP_Block_Type_Registry::get_instance()->get_registered( 'difl/avatar-stack' )->customCssFields;
    }
  ...
  public static function render_callback($attrs, $content, $block, $elements)
    {
        ...
        return Module::render(
            [
                ...
                'classnamesFunction' => [Stack::class, 'module_classnames'],
                'moduleCategory' => $block->block_type->category,
                'stylesComponent' => [Stack::class, 'module_styles'],
                'scriptDataComponent' => [Stack::class, 'module_script_data'],
        ...
        add_action(
            ...
            function () use ($module_json_folder_path) {
                ModuleRegistration::register_module(
                    ...
                    [
                        'render_callback' => [ Stack::class, 'render_callback' ],
          ]
        );
      }
        );
