...
class SVGAnimator implements DependencyInterface {
  ...
  public static function custom_css() {
        return \WP_Block_Type_Registry::get_instance()->get_registered( 'difl/svganimator' )->customCssFields;
    }
  ...
  public static function render_callback($attrs, $content, $block, $elements)
    {
        ...
        wp_enqueue_script('df-svg-animator');
  ...
  public function load()
    {
        $module_json_folder_path = DIFL_MODULES_JSON_PATH . '/svg-animator';
        ...
        add_action(
            ...
            function () use ($module_json_folder_path) {
                ModuleRegistration::register_module(
                    ...
                    [
                        'render_callback' => [ SVGAnimator::class, 'render_callback' ],
          ]
        );
      }
        );
