...
class InstagramFeedCarousel implements DependencyInterface {
  ...
  public static function custom_css() {
        return \WP_Block_Type_Registry::get_instance()->get_registered( 'difl/instagramcarousel' )->customCssFields;
    }
  ...
  public static function render_callback($attrs, $content, $block, $elements)
    {
        ...
        wp_enqueue_script('df-instagram-feed-carousel');
        ...
        return Module::render(
            [
                ...
                'classnamesFunction' => [InstagramFeedCarousel::class, 'module_classnames'],
                'moduleCategory' => $block->block_type->category,
                'stylesComponent' => [InstagramFeedCarousel::class, 'module_styles'],
                'scriptDataComponent' => [InstagramFeedCarousel::class, 'module_script_data'],
        ...
        add_action(
            ...
            function () use ($module_json_folder_path) {
                ModuleRegistration::register_module(
                    ...
                    [
                        'render_callback' => [ InstagramFeedCarousel::class, 'render_callback' ],
          ]
        );
      }
        );
