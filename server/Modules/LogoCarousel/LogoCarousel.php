...
class LogoCarousel implements DependencyInterface {
  ...
  public static function custom_css() {
        return \WP_Block_Type_Registry::get_instance()->get_registered( 'difl/logocarousel' )->customCssFields;
    }
  ...
  public static function render_callback($attrs, $content, $block, $elements)
    {
        ...
        wp_enqueue_script('df-logo-carousel');
        ...
        return Module::render(
            [
                ...
                'classnamesFunction' => [LogoCarousel::class, 'module_classnames'],
                'moduleCategory' => $block->block_type->category,
                'stylesComponent' => [LogoCarousel::class, 'module_styles'],
                'scriptDataComponent' => [LogoCarousel::class, 'module_script_data'],
  ...
  public function load()
    {
        $module_json_folder_path = DIFL_MODULES_JSON_PATH . '/logo-carousel';
