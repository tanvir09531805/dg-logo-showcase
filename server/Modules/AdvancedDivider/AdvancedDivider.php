...
class AdvancedDivider implements DependencyInterface {
  ...
  public static function custom_css() {
        return \WP_Block_Type_Registry::get_instance()->get_registered( 'difl/divider' )->customCssFields;
    }
  ...
  public static function render_callback($attrs, $content, $block, $elements)
    {
        ...
        wp_enqueue_script('df-advanced-divider');
        ...
        return Module::render(
            [
                ...
                'classnamesFunction' => [AdvancedDivider::class, 'module_classnames'],
                'moduleCategory' => $block->block_type->category,
                'stylesComponent' => [AdvancedDivider::class, 'module_styles'],
                'scriptDataComponent' => [AdvancedDivider::class, 'module_script_data'],
        ...
        add_action(
            ...
            function () use ($module_json_folder_path) {
                ModuleRegistration::register_module(
                    ...
                    [
                        'render_callback' => [ AdvancedDivider::class, 'render_callback' ],
          ]
        );
      }
        );
