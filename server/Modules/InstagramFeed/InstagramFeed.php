...
class InstagramFeed implements DependencyInterface {
  ...
  public static function custom_css() {
        return \WP_Block_Type_Registry::get_instance()->get_registered( 'difl/instagramgallery' )->customCssFields;
    }
  ...
  public static function render_callback($attrs, $content, $block, $elements)
    {
        ...
        wp_enqueue_script('df-instagram-feed');
        ...
        return Module::render(
            [
                ...
                'classnamesFunction' => [InstagramFeed::class, 'module_classnames'],
                'moduleCategory' => $block->block_type->category,
                'stylesComponent' => [InstagramFeed::class, 'module_styles'],
                'scriptDataComponent' => [InstagramFeed::class, 'module_script_data'],
        ...
        add_action(
            ...
            function () use ($module_json_folder_path) {
                ModuleRegistration::register_module(
                    ...
                    [
                        'render_callback' => [ InstagramFeed::class, 'render_callback' ],
          ]
        );
      }
        );
