import { AdvancedPricingTableEdit } from './edit';
import metadata from './module.json';
import placeholderContent from './module-default-render-attributes.json';
import { conversionOutline } from './conversion-outline';
import { __ } from "@wordpress/i18n";

export const advancedPricingTableMetadata = metadata;

export const advancedPricingTable = {
  renderers: {
    edit: AdvancedPricingTableEdit,
  },
...
window.vendor.wp.hooks.addFilter(
    'divi.moduleLibrary.moduleAttributes.difl.pricingtable',
    'difl',
    (attributes, metadata) => {
