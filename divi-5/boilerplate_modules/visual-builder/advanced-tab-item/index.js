import { AdvancedTabItemEdit } from './edit';
import metadata from './module.json';
import placeholderContent from './module-default-render-attributes.json';
import { conversionOutline } from './conversion-outline';
import { __ } from "@wordpress/i18n";

export const advancedTabItemMetadata = metadata;

export const advancedTabItem = {
  renderers: {
    edit: AdvancedTabItemEdit,
  },
...
window.vendor.wp.hooks.addFilter(
    'divi.moduleLibrary.moduleAttributes.difl.advancedtabitem',
    'difl',
    (attributes, metadata) => {
