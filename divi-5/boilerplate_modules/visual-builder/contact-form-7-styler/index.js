import { ContactForm7StylerEdit } from './edit';
import metadata from './module.json';
import placeholderContent from './module-default-render-attributes.json';
import { conversionOutline } from './conversion-outline';
import { __ } from "@wordpress/i18n";

export const contactForm7StylerMetadata = metadata;

export const contactForm7Styler = {
  renderers: {
    edit: ContactForm7StylerEdit,
  },
...
window.vendor.wp.hooks.addFilter(
    'divi.moduleLibrary.moduleAttributes.difl.cfseven',
    'difl',
    (attributes, metadata) => {
