import { LogoCarouselItemEdit } from './edit';
import metadata from './module.json';
import placeholderContent from './module-default-render-attributes.json';
import { conversionOutline } from './conversion-outline';
import { __ } from "@wordpress/i18n";

export const logoCarouselItemMetadata = metadata;

export const logoCarouselItem = {
  renderers: {
    edit: LogoCarouselItemEdit,
  },
...
window.vendor.wp.hooks.addFilter(
    'divi.moduleLibrary.moduleAttributes.difl.logocarouselitem',
    'difl',
    (attributes, metadata) => {
