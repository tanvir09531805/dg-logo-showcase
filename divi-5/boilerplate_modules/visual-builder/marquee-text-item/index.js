import { MarqueeTextItemEdit } from './edit';
import metadata from './module.json';
import placeholderContent from './module-default-render-attributes.json';
import { conversionOutline } from './conversion-outline';
import { __ } from "@wordpress/i18n";

export const marqueeTextItemMetadata = metadata;

export const marqueeTextItem = {
  renderers: {
    edit: MarqueeTextItemEdit,
  },
...
window.vendor.wp.hooks.addFilter(
    'divi.moduleLibrary.moduleAttributes.difl.marqueetextitem',
    'difl',
    (attributes, metadata) => {
