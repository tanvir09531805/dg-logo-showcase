import { AdvancedBlurbEdit } from './edit';
import metadata from './module.json';
import placeholderContent from './module-default-render-attributes.json';
import { conversionOutline } from './conversion-outline';
import { __ } from "@wordpress/i18n";

export const advancedBlurbMetadata = metadata;

export const advancedBlurb = {
  renderers: {
    edit: AdvancedBlurbEdit,
  },
...
window.vendor.wp.hooks.addFilter(
    'divi.moduleLibrary.moduleAttributes.difl.advanced-blurb',
    'difl',
    (attributes, metadata) => {
