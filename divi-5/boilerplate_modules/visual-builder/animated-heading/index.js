import { AnimatedHeadingEdit } from './edit';
import metadata from './module.json';
import placeholderContent from './module-default-render-attributes.json';
import { conversionOutline } from './conversion-outline';
import { __ } from "@wordpress/i18n";

export const animatedHeadingMetadata = metadata;

export const animatedHeading = {
  renderers: {
    edit: AnimatedHeadingEdit,
  },
...
window.vendor.wp.hooks.addFilter(
    'divi.moduleLibrary.moduleAttributes.difl.dfadh-heading-anim',
    'difl',
    (attributes, metadata) => {
