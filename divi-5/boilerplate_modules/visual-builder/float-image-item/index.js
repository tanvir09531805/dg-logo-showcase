import { FloatImageItemEdit } from './edit';
import metadata from './module.json';
import placeholderContent from './module-default-render-attributes.json';
import { conversionOutline } from './conversion-outline';
import { __ } from "@wordpress/i18n";

export const floatImageItemMetadata = metadata;

export const floatImageItem = {
  renderers: {
    edit: FloatImageItemEdit,
  },
...
window.vendor.wp.hooks.addFilter(
    'divi.moduleLibrary.moduleAttributes.difl.floatimageitem',
    'difl',
    (attributes, metadata) => {
