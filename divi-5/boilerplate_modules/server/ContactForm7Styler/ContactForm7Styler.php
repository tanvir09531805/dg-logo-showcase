...
class ContactForm7Styler implements DependencyInterface {
  ...
  public static function custom_css() {
        return \WP_Block_Type_Registry::get_instance()->get_registered( 'difl/cfseven' )->customCssFields;
    }
  ...
  public static function render_callback($attrs, $content, $block, $elements)
    {
        ...
        wp_enqueue_script('df-contact-form-7-styler');
        ...
        return Module::render(
            [
                ...
                'classnamesFunction' => [ContactForm7Styler::class, 'module_classnames'],
                'moduleCategory' => $block->block_type->category,
                'stylesComponent' => [ContactForm7Styler::class, 'module_styles'],
                'scriptDataComponent' => [ContactForm7Styler::class, 'module_script_data'],
        ...
        add_action(
            ...
            function () use ($module_json_folder_path) {
                ModuleRegistration::register_module(
                    ...
                    [
                        'render_callback' => [ ContactForm7Styler::class, 'render_callback' ],
          ]
        );
      }
        );
