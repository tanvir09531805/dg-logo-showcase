...
class BusinessHoursItem implements DependencyInterface {
  ...
  public static function render_callback($attrs, $content, $block, $elements)
    {
        ...
        wp_enqueue_script('df-business-hours-item');
        ...
        return Module::render(
            [
                ...
                'classnamesFunction' => [BusinessHoursItem::class, 'module_classnames'],
                'moduleCategory' => $block->block_type->category,
                'stylesComponent' => [BusinessHoursItem::class, 'module_styles'],
                'scriptDataComponent' => [BusinessHoursItem::class, 'module_script_data'],
  ...
  public function load()
    {
        $module_json_folder_path = DIFL5_JSON_PATH . '/business-hours-item';
