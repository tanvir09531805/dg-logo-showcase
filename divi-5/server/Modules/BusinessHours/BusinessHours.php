...
namespace DIVIFLASH5\Modules\BusinessHours;
...
class BusinessHours implements DependencyInterface {
  ...
  public static function render_callback($attrs, $content, $block, $elements)
    {
        ...
        wp_enqueue_script('df-business-hours');
        ...
        return Module::render(
            [
                ...
                'classnamesFunction' => [BusinessHours::class, 'module_classnames'],
                'moduleCategory' => $block->block_type->category,
                'stylesComponent' => [BusinessHours::class, 'module_styles'],
                'scriptDataComponent' => [BusinessHours::class, 'module_script_data'],
  ...
  public function load()
    {
        $module_json_folder_path = DIFL5_JSON_PATH . '/business-hours';
        ...
        add_action(
            ...
            function () use ($module_json_folder_path) {
                ModuleRegistration::register_module(
                    ...
                    [
                        'render_callback' => [ BusinessHours::class, 'render_callback' ],
          ]
        );
      }
        );
