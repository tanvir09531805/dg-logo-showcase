import { PackeryGalleryEdit } from './edit';
import metadata from './module.json';
import placeholderContent from './module-default-render-attributes.json';
import { conversionOutline } from './conversion-outline';
import { __ } from "@wordpress/i18n";

export const packeryGalleryMetadata = metadata;

export const packeryGallery = {
  renderers: {
    edit: PackeryGalleryEdit,
  },
...
window.vendor.wp.hooks.addFilter(
    'divi.moduleLibrary.moduleAttributes.difl.packerygallery',
    'difl',
    (attributes, metadata) => {
