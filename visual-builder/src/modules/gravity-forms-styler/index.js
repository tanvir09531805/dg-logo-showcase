import { GravityFormsStylerEdit } from './edit';
import metadata from './module.json';
import placeholderContent from './module-default-render-attributes.json';
import { conversionOutline } from './conversion-outline';
import { __ } from "@wordpress/i18n";

export const gravityFormsStylerMetadata = metadata;

export const gravityFormsStyler = {
  renderers: {
    edit: GravityFormsStylerEdit,
  },
...
window.vendor.wp.hooks.addFilter(
    'divi.moduleLibrary.moduleAttributes.difl.df-gravity-form',
    'difl',
    (attributes, metadata) => {
