import { SocialShareItemEdit } from './edit';
import metadata from './module.json';
import placeholderContent from './module-default-render-attributes.json';
import { conversionOutline } from './conversion-outline';
import { __ } from "@wordpress/i18n";

export const socialShareItemMetadata = metadata;

export const socialShareItem = {
  renderers: {
    edit: SocialShareItemEdit,
  },
...
window.vendor.wp.hooks.addFilter(
    'divi.moduleLibrary.moduleAttributes.difl.social-share-item',
    'difl',
    (attributes, metadata) => {
