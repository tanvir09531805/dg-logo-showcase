import { TestimonialCarouselItemEdit } from './edit';
import metadata from './module.json';
import placeholderContent from './module-default-render-attributes.json';
import { conversionOutline } from './conversion-outline';
import { __ } from "@wordpress/i18n";

export const testimonialCarouselItemMetadata = metadata;

export const testimonialCarouselItem = {
  renderers: {
    edit: TestimonialCarouselItemEdit,
  },
...
window.vendor.wp.hooks.addFilter(
    'divi.moduleLibrary.moduleAttributes.difl.testimonialcarouselitem',
    'difl',
    (attributes, metadata) => {
