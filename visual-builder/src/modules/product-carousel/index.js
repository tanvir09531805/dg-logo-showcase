import { ProductCarouselEdit } from './edit';
import metadata from './module.json';
import placeholderContent from './module-default-render-attributes.json';
import { conversionOutline } from './conversion-outline';
import { __ } from "@wordpress/i18n";

export const productCarouselMetadata = metadata;

export const productCarousel = {
  renderers: {
    edit: ProductCarouselEdit,
  },
...
window.vendor.wp.hooks.addFilter(
    'divi.moduleLibrary.moduleAttributes.difl.product-carousel',
    'difl',
    (attributes, metadata) => {
