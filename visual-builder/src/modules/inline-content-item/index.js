import { InlineContentItemEdit } from './edit';
import metadata from './module.json';
import placeholderContent from './module-default-render-attributes.json';
import { conversionOutline } from './conversion-outline';
import { __ } from "@wordpress/i18n";

export const inlineContentItemMetadata = metadata;

export const inlineContentItem = {
  renderers: {
    edit: InlineContentItemEdit,
  },
...
window.vendor.wp.hooks.addFilter(
    'divi.moduleLibrary.moduleAttributes.difl.inline-contents-item',
    'difl',
    (attributes, metadata) => {
