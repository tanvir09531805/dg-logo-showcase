...
import { InlineSelect, NumberControl } from '@difl-wp/components';
...
const Typeface = (props) => {
	...
	const renderTextTransform = () => {
		...
		return (
			<InlineSelect
				label={__('Transform', 'divi_flash')}
				value={value.textTransform}
				options={[
					{ value: 'none', label: __('None', 'divi_flash') },
					{
						value: 'capitalize',
						label: __('Capitalize', 'divi_flash'),
					},
					{
						value: 'lowercase',
						label: __('Lowercase', 'divi_flash'),
					},
					{
						value: 'uppercase',
						label: __('Uppercase', 'divi_flash'),
					},
				]}
	...
	const renderLineHeight = () => {
		...
		return (
			<NumberControl
				...
				label={__('Line Height', 'divi_flash')}
				step={
	...
	const renderLetterSpacing = () => {
		...
		return (
			<NumberControl
				...
				label={__('Letter Spacing', 'divi_flash')}
				step={0.1}
	...
	return (
		<>
			...
			<div className="difl-typeface-control difl-white-background-control">
				{renderTextTransform()}
				{renderFontWeight()}
				{renderFontSize()}
				{renderLineHeight()}
