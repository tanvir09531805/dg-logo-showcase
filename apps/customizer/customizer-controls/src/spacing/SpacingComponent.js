...
const SpacingComponent = ({ control }) => {
	...
	const wrapClasses = classnames([
		'difl-white-background-control',
		'difl-sizing',
	]);
	return (
		<div className={wrapClasses}>
			<div className="difl-control-header">
				{label && (
				...
				/>
				<div className="difl-units">{getButtons()}</div>
			</div>
			<SizingControl
				min={min}
				max={max}
