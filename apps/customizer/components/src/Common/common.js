...
export const globalPaletteColors = [
	{
		'nv-primary-accent': __('Primary Accent', 'divi_flash'),
		'nv-secondary-accent': __('Secondary Accent', 'divi_flash'),
		'nv-site-bg': __('Site Background', 'divi_flash'),
		'nv-light-bg': __('Light Background', 'divi_flash'),
		'nv-dark-bg': __('Dark Background', 'divi_flash'),
		'nv-text-color': __('Text Color', 'divi_flash'),
		'nv-text-dark-bg': __('Text Dark Background', 'divi_flash'),
		'nv-c-1': __('Extra Color 1', 'divi_flash'),
		'nv-c-2': __('Extra Color 2', 'divi_flash'),
	},
];
