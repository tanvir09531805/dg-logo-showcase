...
const ResponsiveControl = (props) => {
	...
	const devices = {
		desktop: {
			tooltip: __('Desktop', 'divi_flash'),
			icon: 'desktop',
		},
		tablet: {
			tooltip: __('Tablet', 'divi_flash'),
			icon: 'tablet',
		},
		mobile: {
			tooltip: __('Mobile', 'divi_flash'),
			icon: 'smartphone',
		},
	};
	...
	return (
		<>
			<div className="difl-responsive-control-bar">
				{controlLabel && (
			...
			{children && (
				<div className="difl-responsive-controls-content">
					{children}
				</div>
			)}
		</>
