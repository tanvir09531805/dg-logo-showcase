...
class CptItem extends Component {
    ...
    static css(props) {
        const additionalCss = [];
        const meta = ['author', 'date', 'taxonomy', 'custom_text', 'icon', 'acf_fields', 'pod_fields', 'metabox_fields'];
        ...
        const metaDisplay = undefined !== props.meta_display ? props.meta_display : 'inline-flex';
        const iconImageVerticalAlign = undefined !== props.icon_image_verticle_align ? props.icon_image_verticle_align : 'text-top';

        if(metaDisplay !== 'inline-flex' ) {
            additionalCss.push([{
                selector:    '%%order_class%%.df-item-wrap .df-icon-image',
                declaration: `vertical-align: ${iconImageVerticalAlign};`,
            }]);
        } else {
            ...
            additionalCss.push([{
                ...
                declaration: `align-items: ${icon_image_vertical_align[iconImageVerticalAlign]};`,
            }]);
        }
        utility.process_range_value({
            'props'             : props,
