    ...
    public function get_advanced_fields_config() {
        ...
        $advanced_fields['fonts'] = array(
            ...
            'before_after'     => array(
                ...
                'css'      => array(
                   'main' => "{$this->main_css_element}.df-item-wrap .before-text, {$this->main_css_element}.df-item-wrap .after-text",
                    'hover' => ".df-post-outer-wrap:hover {$this->main_css_element} .before-text, .df-post-outer-wrap:hover {$this->main_css_element} .after-text",
                    'important'    => 'all'
                ),
