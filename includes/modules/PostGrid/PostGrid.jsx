...
class PostGrid extends Component {
    ...
    constructor(props) {
        ...
        'older_text', 'newer_text', 'equal_height', 'use_number_pagination', 'show_pagination'];
    }
    ...
    static css(props) {
        ...
        additionalCss.push([{
            ...
            declaration: `content: '${PostGrid.arrow_icon(props.next_prev_icon, 'next')}';`
        }]);
        additionalCss.push([{
            selector:    '%%order_class%% .pagination .older:before, %%order_class%% .pagination .prev:before',
            declaration: `content: '${PostGrid.arrow_icon(props.next_prev_icon, 'prev')}';`
        }]);
            ...
            <div>
                {this.state.loading === false ? 
                    <React.Fragment>
                        ...
                        <div className="df_postgrid_container" dangerouslySetInnerHTML={this.render_output()} ref={this.wrapper} /> 
                    </React.Fragment>
                    : 
