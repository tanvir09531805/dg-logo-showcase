...
/**
 * Advanced Menu: Render Menus for DIVI5 Menu in VB
 *
 */
add_action('wp_ajax_df_vertical_am_menu_divi5', 'df_vertical_am_menu_divi5');
function df_vertical_am_menu_divi5()
{
